...
public class Main {
    ...
    public static void endGame() {
        ...
        gameData.friendObject.add(new Text("GAME OVER", 250, 200, Color.RED, font));
        Main.win.showLeaderboardButton();
        updateLeaderBoardStats();
    }

    private static void updateLeaderBoardStats(){
        leaderboardData[0] = new String[]{"1", Integer.toString(playedTime), Integer.toString(Shooter.getPlayerScore())};
    }
    ...
    private static void startWave(String type) {
        // kill off enemies
        Main.gameData.enemyObject.clear();
    ...
    private static boolean isAsteroidWave = false;
    ...
    private static void gameLoop() {
        ...
        while (running) {
            ...
            if (Bird.AVAILABLE_UNITS <= 0 && Asteroid.AVAILABLE_UNITS <= 0) {
                isAsteroidWave = !isAsteroidWave;
                startWave(isAsteroidWave ? "asteroids" : "birds");
            }
        }
    }
